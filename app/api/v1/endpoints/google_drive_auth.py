...
def _build_post_connect_redirect(
    *,
    ...
    query_params["provider"] = "google-drive"
...
async def oauth_google_drive_start(
    ...
    request.session["google_drive_oauth_return_to"] = resolved_return_to
    request.session["google_drive_oauth_request_origin"] = request.headers.get("origin")
...
async def oauth_google_drive_callback(request: Request):
    session_state = request.session.pop("google_drive_oauth_state", None)
    session_user_id = request.session.pop("google_drive_oauth_user_id", None)
    session_user_jwt = request.session.pop("google_drive_oauth_user_jwt", None)
    session_return_to = request.session.pop("google_drive_oauth_return_to", None)
    session_request_origin = request.session.pop(
        "google_drive_oauth_request_origin",
        None,
    )
